...
Replace all {{PLACEHOLDER}} values with your information:
  What Is This?     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  atsiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/atsiser/security/advisories/new)
...
- This repository (`hyperpolymath/atsiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/atsiser/security/advisories)
...
When using What Is This?, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/atsiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/atsiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/atsiser/discussions) |
...
*Thank you for helping keep What Is This? and its users safe.* 🛡️
